...
function Intro(){
    return (
        <section className="intro">
            ...
            <p>During the lockdown I found that I had a lot of time on my hands so I decided to improve my front-end development skills and learn a new technology. I decided on React for a number of reasons:</p>
            <ul>
