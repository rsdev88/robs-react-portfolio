...
function Intro(){
    return (
        <section className="intro">
            ...
            <p>During the lockdown I had a lot of time on my hands, so I decided to improve my front-end development skills and learn a new technology. I decided on React for a number of reasons:</p>
            <ul>
                <li>It's highly popular amongst front-end developers with a huge community using it and sharing advice and tips online</li>
                <li>It's used by many world-class, high-profile companies and is highly sought after by employers</li>
                <li>It's actively maintained and supported by Facebook so it's not going away soon!</li>
            </ul> 
            <p>I started by completing several React courses on <a href="https://scrimba.com">Scrimba</a> to learn the fundamentals before advancing to their full <a href="https://scrimba.com/course/greact/enrolled">Bootcamp</a>. This took around six weeks but my skills have grown tremendously during that time. Scrimba aligned perfectly with my hands-on approach to learning and so after completing the courses and Bootcamp, I've put what I learnt into practice by building several small sites and web apps.</p>
